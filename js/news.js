        ...
        function fetchCategoryAPI()
        {
         ...
         .then((data) => {
            ...
            for(const j in data['categories'])
            {
                ...
                {
                    disp3='<button class="btn btn-lg my-4 button1 shadow-sm newsbtn" id=%id% value=%category1% onclick="category(%idd%)">%category% </button>'; 
                    disp4='<button class="btn btn-lg my-4 button1 shadow-sm newsbtn" style="width:80%;" id=%id% value=%category1% onclick="category(%idd%)">%category% </button>'; 
                ...
                if(data['categories'][j]['categoryName']!=null)
                {
                    ...
                    {
                        disp2='<button class="btn btn-lg my-4 button1 shadow-sm newsbtn" id=%id% value=%category1% onclick="category(%idd%)">%category% </button>';
                        disp1='<button class="btn btn-lg my-4 button1 shadow-sm newsbtn" style="width:80%;" id=%id% value=%category1% onclick="category(%idd%)">%category% </button>';
